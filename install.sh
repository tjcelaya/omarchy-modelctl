...
#   ~/.local/share/man/man1/modelctl.1  the manual (`man modelctl`)
...
mkdir -p ~/.local/share/man/man1 && ln -sf "$SRC/docs/modelctl.1" ~/.local/share/man/man1/modelctl.1
...
echo "change that and everything else in ~/.config/modelctl/models.conf. Manual: man modelctl"
